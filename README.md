...
# Examples 
Examples for using the Hecatron functions with the Muse 2 and the synthetic board can be found in muse_example.py and synthetic_example.py respectively
